...
class Processor extends EventEmitter {
    ...
    async process_one(system, opts) {
        ...
        try {
            ...
            // Error actioning or evaluating the anomaly.  
            anomaly.log.error("process_one(): error processing anomaly: " + err.message);
            try {
                ...
                anomaly.log.error("process_one(): error reverting anomaly: " + e.message);
                anomaly.pause("revert() failed after action() - anomaly is in unknown state" + err.message);
            }
