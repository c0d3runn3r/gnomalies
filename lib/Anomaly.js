...
class Anomaly extends EventEmitter {
    ...
    async action(system, opts) {
        ...
        if(this.#use_fingerprints) {
            ...
            // Take fingerprints
            this.log.debug(`action(): using fingerprints`);
            ...
            this.log.debug(`action(): fingerprints - preaction = ${this.#fingerprints.preaction} postaction = ${this.#fingerprints.postaction}`);
                ...
                this.log.debug(`action(): Not using fingerprints`);
                this.log.debug(`action(): calling _action()`);
                await this._action(system, opts);
        }
    ...
    async revert(system, opts) {
        ...
        if(this.#use_fingerprints) {
            this.log.debug(`revert(): Using fingerprints`);
            ...
            this.log.debug(`revert(): Not using fingerprints`);
            if(this.state == "preaction") {

                this.log.info(`revert(): Anomaly is in a preaction state, no need to revert`);
