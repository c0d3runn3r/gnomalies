...
/**
 * Activity
 * An anomaly is experiencing an activity
 * 
 * @event Anomaly#activity
 * @type {object} 
 * @property {Anomaly} anomaly the anomaly
 * @property {string} activity the activity, one of ("action" | "revert" | "evaluate")
...
class Anomaly extends EventEmitter {
    ...
    fingerprint(system) {
        ...
        this.log.debug(`fingerprint(): ${hash}`);
        return hash;
    }
